<?php
/**
 * Wrapper for session, read and store values on session. Maintaines flash values for one pageload.
 * 
 * @package LibraCore
 */
class CSession {
     ...
     * 
     * @return array of messages. Each array-item contains a key and a value.
     */
