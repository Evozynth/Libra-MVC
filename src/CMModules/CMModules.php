<?php
/**
 * A model for managing Libra modules.
 * 
 * @package LibraCore
 */
class CMModules extends CObject {
     ...
     * Properties
     */
    private $libraCoreModules = array('CLibra', 'CDatabase', 'CRequest', 'CViewContainer', 'CSession', 'CObject');
    private $libraCMFModules = array('CForm', 'CCPage', 'CCBlog', 'CMUser', 'CCuser', 'CMContent', 'CCContent', 'CFormUserLogin', 'CFormUserProfile', 'CFormUserCreate', 'CFormContent', 'CTextFilter');
    ...
    private function GetDetailsOfModule($module) {
        ...
        if (class_exists($module)) {
            ...
            $details['isLibraCore']      = in_array($rc->name, $this->libraCoreModules);
            $details['isLibraCMF']       = in_array($rc->name, $this->libraCMFModules);
